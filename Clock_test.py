...
# UI STUFF
# FOR THE LOVE OF GOD DON'T CHANGE ANY VARIABLE NAMES
...
clock1 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20)
text1 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20, text = 'Earth')

clock2 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20)
text2 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20, text = 'Sun')

clock3 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20)
text3 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20, text = 'PSR B1919+21')

clock4 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20)
text4 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20, text = 'GW150914')

clock5 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20)
text5 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20, text = 'Gargantua')

clock6 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20)
text6 = Label(root, font=('times', 20, 'bold'), bg='grey', padx = 30, pady = 20, text = 'NGC 1277')
